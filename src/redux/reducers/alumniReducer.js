...
const justRegistered = createAction('justRegistered');
const clearError = createAction('clearError');
const clearMessage = createAction('clearMessage');

export const alumniReducer = createReducer({
    ...
    builder
        ...
        .addCase(justRegistered, (state) => {
            console.log("in the just Registed reducer")
